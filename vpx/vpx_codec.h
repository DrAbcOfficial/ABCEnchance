 ...
 *
 */
extern const char *(*vpx_codec_error)(vpx_codec_ctx_t *ctx);
 ...
 */
extern const char * (*vpx_codec_error_detail)(vpx_codec_ctx_t *ctx);
 ...
 */
extern vpx_codec_err_t (*vpx_codec_destroy)(vpx_codec_ctx_t *ctx);
