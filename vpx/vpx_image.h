 ...
 *         returned.
 */
extern vpx_image_t* (*vpx_img_alloc)(vpx_image_t *img, vpx_img_fmt_t fmt,
 ...
 *         returned.
 */
extern vpx_image_t *(*vpx_img_wrap)(vpx_image_t *img, vpx_img_fmt_t fmt, unsigned int d_w,
 ...
 */
extern int (*vpx_img_set_rect)(vpx_image_t *img, unsigned int x, unsigned int y,
 ...
 * \param[in]    img       Image descriptor
 */
extern void (*vpx_img_flip)(vpx_image_t *img);
 ...
 * \param[in]    img       Image descriptor
 */
extern void (*vpx_img_free)(vpx_image_t *img);
