...
#include "GameUI/KeyToggleCheckButton.h"
#include "GameUI/CvarNegateCheckButton.h"
...
COptionsSubMouse::COptionsSubMouse(vgui::Panel *parent) : PropertyPage(parent, NULL)
{
	...
	m_pMouseSensitivityLabel = new vgui::TextEntry(this, "SensitivityLabel");
	...
	float sensitivity = gEngfuncs.pfnGetCvarFloat("sensitivity");
	char buf[64];
...
void COptionsSubMouse::ApplySchemeSettings(vgui::IScheme *pScheme)
{
