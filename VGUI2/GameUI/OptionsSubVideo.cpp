...
COptionsSubVideo::COptionsSubVideo(vgui::Panel *parent) : PropertyPage(parent, NULL)
{
	...
	m_pMode = new vgui::ComboBox(this, "Resolution", 6, false);

	m_pAspectRatio = new vgui::ComboBox( this, "AspectRatio", 2, false );
	...
	wchar_t *unicodeText = vgui::localize()->Find("#GameUI_AspectNormal");
	vgui::localize()->ConvertUnicodeToANSI(unicodeText, m_pszAspectName[0], 32);
    unicodeText = vgui::localize()->Find("#GameUI_AspectWide");
	vgui::localize()->ConvertUnicodeToANSI(unicodeText, m_pszAspectName[1], 32);
    ...
    unicodeText = vgui::localize()->Find("#GameUI_Software");
	vgui::localize()->ConvertUnicodeToANSI(unicodeText, m_pszRenderNames[0], 32);
    unicodeText = vgui::localize()->Find("#GameUI_OpenGL");
	vgui::localize()->ConvertUnicodeToANSI(unicodeText, m_pszRenderNames[1], 32);
    unicodeText = vgui::localize()->Find("#GameUI_D3D");
	vgui::localize()->ConvertUnicodeToANSI(unicodeText, m_pszRenderNames[2], 32);

	m_pRenderer = new vgui::ComboBox( this, "Renderer", 3, false ); // "#GameUI_Renderer"
	int i;
	for (i = 0; i < 3; i++)
    {
	...
	m_pColorDepth = new vgui::ComboBox( this, "ColorDepth", 2, false );
	...
	bool detailTexturesSupported = gEngfuncs.pfnGetCvarFloat( "r_detailtexturessupported" ) > 0;
