...
CCvarNegateCheckButton::CCvarNegateCheckButton(vgui::Panel *parent, const char *panelName, const char *text, const char *cvarname) : vgui::CheckButton(parent, panelName, text)
{
...
void CCvarNegateCheckButton::Paint(void)
{
	...
	float value = gEngfuncs.pfnGetCvarFloat(m_pszCvarName);
...
void CCvarNegateCheckButton::ApplyChanges(void)
{
	...
	gEngfuncs.Cvar_SetValue(m_pszCvarName, m_bStartState ? value : -value);
}
