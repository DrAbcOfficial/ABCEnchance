...
public:
	...
	virtual void SetVariables(float flGravity, CVector vViewAngles) = 0;
	virtual void ResetParticles(void) = 0;
	virtual void ApplyForce(CVector vOrigin, CVector vDirection, float flRadius, float flStrength, float flDuration) = 0;
	...
	virtual CBaseParticle* CreateParticle(CVector org, CVector normal, model_s* sprite, float size, float brightness, const char* classname) = 0;
	...
	virtual void CoreInitializeSprite(CCoreTriangleEffect* pParticle, CVector org, CVector normal, model_s* sprite, float size, float brightness) = 0; //Only use this for TrianglePlanes
	...
	virtual void CoreTouch(CCoreTriangleEffect* pParticle, CVector pos, CVector normal, int index) = 0;
...
public:
	...
	virtual void Touch(CVector pos, CVector normal, int index) { g_pParticleMan->CoreTouch(this, pos, normal, index); }
	...
	virtual void InitializeSprite(CVector org, CVector normal, model_s* sprite, float size, float brightness)
	{
