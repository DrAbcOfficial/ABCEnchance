...
extern CURLcode(*curl_easy_setopt)(void* curl, CURLoption option, ...);
extern CURLcode(*curl_easy_getinfo)(void* curl, CURLINFO info, ...);
extern CURLcode(*curl_easy_perform)(void* curl);
