...
#define MAX_WEAPON_POS_INDEX MAX_WEAPON_POSITIONS - 1
#define MAX_WEAPON_POSUSER_INDEX MAX_WEAPON_POSITIONS_USER - 1

#define MAX_WEAPON_SLOTS 10
#define MAX_WEAPON_SLOT_INDEX MAX_WEAPON_SLOTS - 1
