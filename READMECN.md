...
|---|---|---|---|
|hud_rainbow_menu|绘制武器菜单彩虹圈|0|0/1/2|
|---|---|---|---|
|hud_highlight_item|是否显示物品高亮|1|0/1|
|hud_highlight_item_range|物品高亮范围|344|0~500|
|---|---|---|---|
|hud_danger_health|濒死生命值|45|0~9999|
|hud_danger_armor|濒死护甲值|45|0~9999|
|hud_damageshock|启用受伤色差|0|0/1|
|hud_damageshock_factor|受伤色差强度|0.015|0~99999|
|hud_damageshock_base|出现色差应受伤害|30|0~99999|
|---|---|---|---|
|hud_deathnotice|用新的死亡提示|1|0~1|
|hud_deathnotice_time|死亡提示保持时间|6|0~9999|
|---|---|---|---|
|hud_radar|启用雷达|2|0/1/2|
|hud_radarzoom|雷达缩放倍数|2.5|0.0001~9999|
|hud_radarupdateint|雷达更新频率（秒）|1|0-9999|
|---|---|---|---|
|hud_playerinfo|展示玩家状态栏|1|0/1/2|
|hud_playerinfo_danger|危险血量|30|啥都行|
|---|---|---|---|
...
|---|---|---|---|
|hud_sideinfo|开启分数速度等的侧边文字栏|1|0/1|
