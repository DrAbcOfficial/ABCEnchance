...
namespace vgui
{
	...
	public:
		...
		void RunAnimationCommand(Panel* panel, const char* variable, Vector targetValue, float startDelaySeconds, float duration, Interpolators_e interpolator, float animParameter = 0);
	private:
