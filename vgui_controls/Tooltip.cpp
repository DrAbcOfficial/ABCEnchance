...
void Tooltip::SetEnabled(bool bState)
{
	_enabled = bState;
}
...
// Purpose:
//-----------------------------------------------------------------------------
bool Tooltip::ShouldLayout(void)
{
	if (!_makeVisible)
		return false;
...
//-----------------------------------------------------------------------------
void Tooltip::PositionWindow(Panel* pTipPanel)
{
	int iTipW, iTipH;
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
TextTooltip::TextTooltip(Panel* parent, const char* text) : Tooltip(parent, text)
{
...
void TextTooltip::ShowTooltip(Panel* currentPanel)
{
	...
	Tooltip::ShowTooltip(currentPanel);
}
