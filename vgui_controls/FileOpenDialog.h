...
namespace vgui
{
	...
	class FileOpenDialog : public Frame
	{
	...
	private:
		...
		ComboBox* m_pFileTypeCombo;
		Button* m_pOpenButton;
		Button* m_pCancelButton;
		Button* m_pFolderUpButton;
		Button* m_pNewFolderButton;
		Button* m_pOpenInExplorerButton;
		ImagePanel* m_pFolderIcon;
		Label* m_pFileTypeLabel;
		...
		VPANEL				m_SaveModal;
		DHANDLE< InputDialog >	m_hInputDialog;
	};
