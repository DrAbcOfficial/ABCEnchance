...
//-----------------------------------------------------------------------------
	...
	public:
		...
		Tooltip* GetTooltip();
		void	SetTooltip(Tooltip* pToolTip, const char* pszText);
	...
	public:
		...
		*/
		...
		const char* GetNavUpName(void) const { return m_sNavUpName.c_str(); }
		const char* GetNavDownName(void) const { return m_sNavDownName.c_str(); }
		const char* GetNavLeftName(void) const { return m_sNavLeftName.c_str(); }
		const char* GetNavRightName(void) const { return m_sNavRightName.c_str(); }
		const char* GetNavToRelayName(void) const { return m_sNavToRelayName.c_str(); }
		const char* GetNavActivateName(void) const { return m_sNavActivateName.c_str(); }
		const char* GetNavBackName(void) const { return m_sNavBackName.c_str(); }
	...
	private:
		...
		std::string	m_sNavUpName;
		PHandle		m_NavUp;

		std::string m_sNavDownName;
		PHandle m_NavDown;

		std::string m_sNavLeftName;
		PHandle m_NavLeft;

		std::string m_sNavRightName;
		PHandle m_NavRight;

		std::string m_sNavToRelayName;
		PHandle m_NavToRelay;

		std::string m_sNavActivateName;
		PHandle m_NavActivate;

		std::string m_sNavBackName;
		PHandle m_NavBack;
