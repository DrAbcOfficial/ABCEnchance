...
// Purpose: Constructor
//-----------------------------------------------------------------------------
LabelEx::LabelEx(Panel* parent, const char* panelName, const char* text) : Panel(parent, panelName)
{
	Init();
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
LabelEx::LabelEx(Panel* parent, const char* panelName, const wchar_t* wszText) : Panel(parent, panelName)
{
	Init();
...
//-----------------------------------------------------------------------------
void LabelEx::SetTextColorState(EColorState state)
{
...
//-----------------------------------------------------------------------------
void LabelEx::GetContentSize(int& wide, int& tall)
{
...
//-----------------------------------------------------------------------------
wchar_t LabelEx::CalculateHotkey(const char* text)
{
...
wchar_t LabelEx::CalculateHotkey(const wchar_t* text)
{
	if (text)
	{
...
//-----------------------------------------------------------------------------
Panel* LabelEx::HasHotkey(wchar_t key)
{
...
//-----------------------------------------------------------------------------
void LabelEx::SetHotkey(wchar_t ch)
{
	_hotkey = ch;
}
...
//-----------------------------------------------------------------------------
void LabelEx::OnMousePressed(MouseCode code)
{
	if (_associate.Get() && !IsBuildModeActive())
	{
		_associate->RequestFocus();
...
//-----------------------------------------------------------------------------
void LabelEx::GetText(char* textOut, int bufferLen)
{
...
// Purpose: Return the text in the label
//-----------------------------------------------------------------------------
void LabelEx::GetText(wchar_t* textOut, int bufLenInBytes)
{
...
//-----------------------------------------------------------------------------
void LabelEx::SetText(const char* text)
{
...
//-----------------------------------------------------------------------------
void LabelEx::SetText(const wchar_t* unicodeString, bool bClearUnlocalizedSymbol)
{
...
//-----------------------------------------------------------------------------
void LabelEx::OnDialogVariablesChanged(KeyValues* dialogVariables)
{
...
//-----------------------------------------------------------------------------
void LabelEx::SetTextInset(int xInset, int yInset)
{
	_textInset[0] = xInset;
	_textInset[1] = yInset;
...
//-----------------------------------------------------------------------------
void LabelEx::SetEnabled(bool state)
{
...
//-----------------------------------------------------------------------------
void LabelEx::ComputeAlignment(int& tx0, int& ty0, int& tx1, int& ty1)
{
	int wide, tall;
	...
	for (int i = 0; i < _imageDar.Count(); i++)
	{
		...
		if (iWide > wide) // if the image is larger than the label just do a west alignment
			actualXAlignment = LabelEx::a_west;
	...
	{
		// left
	case LabelEx::a_northwest:
	case LabelEx::a_west:
	case LabelEx::a_southwest:
	{
		tx0 = 0;
		break;
	}
	// center
	case LabelEx::a_north:
	case LabelEx::a_center:
	case LabelEx::a_south:
	{
		tx0 = (wide - tWide) / 2;
		break;
	}
	// right
	case LabelEx::a_northeast:
	case LabelEx::a_east:
	case LabelEx::a_southeast:
	{
		tx0 = wide - tWide;
		break;
	}
...
void LabelEx::Paint()
{
	...
	for (int i = 0; i < _imageDar.Count(); i++)
	{
		...
		if (_contentAlignment == LabelEx::a_west || _contentAlignment == LabelEx::a_center || _contentAlignment == LabelEx::a_east)
		{
			int iw, it;
			image->GetSize(iw, it);
			if (it < (ty1 - ty0))
...
//-----------------------------------------------------------------------------
void LabelEx::DrawDashedLine(int x0, int y0, int x1, int y1, int dashLen, int gapLen)
{
...
void LabelEx::SetContentAlignment(Alignment alignment)
{
...
//-----------------------------------------------------------------------------
void LabelEx::SetFont(HFont font)
{
...
//-----------------------------------------------------------------------------
void LabelEx::OnSizeChanged(int wide, int tall)
{
	InvalidateLayout();
...
//-----------------------------------------------------------------------------
HFont LabelEx::GetFont()
{
	return _textImage->GetFont();
}

//-----------------------------------------------------------------------------
// Purpose: Set the foreground color of the LabelEx
//-----------------------------------------------------------------------------
void LabelEx::SetFgColor(Color color)
{
	if (!(GetFgColor() == color))
	{
...
//-----------------------------------------------------------------------------
// Purpose: Get the foreground color of the LabelEx
//-----------------------------------------------------------------------------
Color LabelEx::GetFgColor()
{
...
//-----------------------------------------------------------------------------
// Purpose: Set the foreground color 1 color of the LabelEx
//-----------------------------------------------------------------------------
void LabelEx::SetDisabledFgColor1(Color color)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void LabelEx::SetDisabledFgColor2(Color color)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
Color LabelEx::GetDisabledFgColor1()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
Color LabelEx::GetDisabledFgColor2()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
TextImageEx* LabelEx::GetTextImage()
{
	return _textImage;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
bool LabelEx::RequestInfo(KeyValues* outputData)
{
...
//-----------------------------------------------------------------------------
void LabelEx::OnSetText(KeyValues* params)
{
...
//-----------------------------------------------------------------------------
int LabelEx::AddImage(IImage* image, int offset)
{
...
//-----------------------------------------------------------------------------
void LabelEx::ClearImages()
{
	_imageDar.RemoveAll();
	_textImageIndex = -1;
}

void LabelEx::ResetToSimpleTextImage()
{
	ClearImages();
	_textImageIndex = AddImage(_textImage, 0);
}
...
//-----------------------------------------------------------------------------
void LabelEx::SetImageAtIndex(int index, IImage* image, int offset)
{
...
//-----------------------------------------------------------------------------
IImage* LabelEx::GetImageAtIndex(int index)
{
...
//-----------------------------------------------------------------------------
int LabelEx::SetTextImageIndex(int newIndex)
{
...
//-----------------------------------------------------------------------------
void LabelEx::EnsureImageCapacity(int maxIndex)
{
...
//-----------------------------------------------------------------------------
void LabelEx::SetImagePreOffset(int index, int preOffset)
{
...
//-----------------------------------------------------------------------------
void LabelEx::SetImageBounds(int index, int x, int width)
{
...
//-----------------------------------------------------------------------------
// Purpose: LabelExs can be associated with controls, and alter behaviour based on the associates behaviour
...
//-----------------------------------------------------------------------------
void LabelEx::SetAssociatedControl(Panel* control)
{
	if (control != this)
	{
		_associate = control;
...
//-----------------------------------------------------------------------------
void LabelEx::OnRequestFocus(VPANEL subFocus, VPANEL defaultPanel)
{
...
//-----------------------------------------------------------------------------
void LabelEx::ApplySchemeSettings(IScheme* pScheme)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void LabelEx::GetSettings(KeyValues* outResourceData)
{
	// panel settings
...
// Purpose: 
//-----------------------------------------------------------------------------
void LabelEx::ApplySettings(KeyValues* inResourceData)
{
...
//-----------------------------------------------------------------------------
const char* LabelEx::GetDescription(void)
{
...
void LabelEx::SetWrap(bool bWrap)
{
	m_bWrap = bWrap;
